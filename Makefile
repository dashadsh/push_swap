...
#    Updated: 2022/10/29 01:22:19 by dgoremyk         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = utils_atoi.c utils_free.c utils_final_rotation.c \
	utils_input.c utils_input2.c push_swap.c utils_cost_calculation.c \
	utils_array.c utils_ll.c utils_triplesort.c utils_instructions.c \
